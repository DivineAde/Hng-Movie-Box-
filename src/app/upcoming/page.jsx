      ...
      {results.map((series) => (
        <div key={series.id} series={series} data-testid="movie-card" className="pb-6">
          <div className="relative">
            ...
            />
            <button className="absolute top-[5%] left-[80%] bg-transparent p-2 rounded-full">
              <AiFillHeart className="w-7 h-7 text-red-600" />
            </button>
            <button className="absolute top-[5%] right-[80%] bg-transparent p-2 rounded-full">
              <AiFillHeart className="w-7 h-7 text-red-600" />
            </button>
          </div>
